...
**D Consulting** מלווה מלונות בוטיק ובתי אירוח בישראל ובעולם בתמחור, בניהול ערוצי המכירה
...
**גילוי נאות:** חלק מהעבודה חוזר על עצמו כל שבוע, מול מועד הגשה קבוע, ובמספרים שטעות
בהם עולה כסף ללקוח. מי שזה לא מתאים לו — עדיף שיבין את זה עכשיו ולא בעוד חודשיים.
...
- יכולת ללמוד מערכות חדשות לבד — מי שנכנס לממשק ניהול שלא הכיר ומוצא בו את דרכו
...
- עבודה היברידית — עיקר העבודה מהבית, עם מפגשי עבודה באזור המרכז
...
>
> **מתאים למי ש:** יש לו ראש אנליטי ועין לפרטים, חזק/ה באקסל, לומד/ת מערכות חדשות לבד,
...
> ובתעריפי קונסורציות**.
>
> **גילוי נאות:** חלק מהעבודה חוזר על עצמו כל שבוע, מול מועד הגשה קבוע.
>
...
D Consulting advises boutique hotels and hospitality properties in Israel and internationally on
...
with you, hybrid — mostly from home, with working sessions in central Israel — and real room to grow as the business does.
